    ...
    <section class="banner banner-two hidden-xs">
      <div class="banner-slider swiper-container">
        <div class="swiper-wrapper">
          <div class="banner-item slide-eight swiper-slide">
          ...
          <div class="banner-item slide-three swiper-slide">
           ...
           <div class="banner-item slide-six swiper-slide">
            <div class="banner-overlay"></div>
              <div class="container">
                <div class="banner-content">
           ...
           <div class="banner-item slide-seven swiper-slide">
            <div class="banner-overlay"></div>
              <div class="container">
                <div class="banner-content">
      ...
      <div class="banner-slider swiper-container">
        <div class="swiper-wrapper">
          <div class="banner-item  swiper-slide">
            <img src="{{ asset('images/banner/omax.jpg') }}" class="img-responsive" width="100%" alt="">
          </div><!-- slide item --> 
           <div class="banner-item  swiper-slide"> 
            <img src="{{ asset('images/banner/banner_04.jpg') }}" class="img-responsive" width="100%" alt="">
          </div><!-- slide item -->
           <div class="banner-item  swiper-slide"> 
            <img src="{{ asset('images/banner/banner_05.jpg') }}" class="img-responsive" width="100%" alt="">
          </div><!-- slide item -->
           <div class="banner-item  swiper-slide"> 
            <img src="{{ asset('images/banner/banner_06.jpg') }}" class="img-responsive" width="100%" alt="">
          </div><!-- slide item -->
           <div class="banner-item  swiper-slide"> 
            <img src="{{ asset('images/banner/banner_07.jpg') }}" class="img-responsive" width="100%" alt="">
          </div><!-- slide item -->
           <div class="banner-item  swiper-slide"> 
            <img src="{{ asset('images/banner/banner_08.jpg') }}" class="img-responsive" width="100%" alt="">
          </div><!-- slide item -->
        </div><!-- swiper-wrapper -->
        <div class="swiper-pagination"></div>
      </div><!-- swiper-container -->
            ...
            <div class="teacher-slider swiper-container">
              <div class="swiper-wrapper">
                ...
                <div class="teacher-item swiper-slide">
                  ...
                  <div class="teacher-content">
                    <h4><a href="#">DEEPA ISPUNIYANI</a></h4>                    
                  </div>               
                </div><!-- teacher-item -->
